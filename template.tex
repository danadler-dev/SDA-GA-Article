...
In the unconstrained simulations, all the resulting patterns had the same stability of 1 generation, so the dynamics reduce to random search: no patterns persist across generations, no memory accumulates, and no bias arises to skew the population distribution which remains uniform. 
